...
async def capture_bucket_backfilled_broker_snapshot(
    ...
    Alpaca broker payloads do not carry Manager allocation buckets.

    This second sync keeps Database positions/open orders aligned with

    Manager's latest selected_positions without changing broker state
...
async def run_guarded_discover_analyze_trade_flow(
    ...
    snapshot_capture = (
        ...
        await capture_broker_snapshot(account_id, correlation_id)
    ...
    if isinstance(response.data, dict):
        ...
        if isinstance(portfolio_summary, dict):
            ...
            portfolio_summary.setdefault(
                ...
                "broker_snapshot_capture_status",
            ...
            portfolio_summary.setdefault(
                ...
                "bucket_backfill_capture_status",
