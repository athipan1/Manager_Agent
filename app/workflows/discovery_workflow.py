            ...
            for item in ranked:
                ...
                await persist_signal(
                    ...
                    extra_metadata={
                        ...
                        "skipped_existing_protected_position": item["symbol"]

                        in {row["symbol"] for row in skipped_existing_protected_positions},

                        "curator_signal": curator_signals_by_symbol.get(item["symbol"]),
